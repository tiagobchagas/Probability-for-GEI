...
x_lab <- "Adjusted means ACG"
y_lab <- "Density"
#x_title <- ""
x_title <- "A: Observed against generated data ACG" 
(p1A <- ggplot(data_fig1, aes(x = y, colour = type)) + 
                ...
                ylim(0, 1.7) + labs(x = x_lab, y = y_lab, title = x_title)) 
...
rm(g_postChecks)
# PLots
x_lab <- "Genetic values ACG"
y_lab <- "Families derived from Cycle III Recurrent Selection"
x_title <- "B: 95 % Highest posterior density interval ACG"
levels(df$H)
# Plot 
...
y_lab <- "Probability of superior performance ACG"
x_title <- "C: Marginal probability of superior performance ACG"
...
x_lab <- "Families derived Cycle III Recurrent Selection"
y_lab <- "Families derived Cycle III Recurrent Selection ACG"
x_title <- "D: Pairwise probability of superior performance ACG"
...
x_title <- "A: Bayesian Eskridge Risk index ACG"
dev.off()
...
x_lab <- 'Families derived Cycle III Recurrent Selection'
y_lab <- 'Probabilities'
x_title <- "B: Joint probability of superior performance and stability ACG"
